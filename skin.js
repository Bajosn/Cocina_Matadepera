...
function pano2vrSkin(player,base) {
	...
	this.addSkin=function() {
		...
		hs ='';
		hs+='height : 64px;';
		hs+='left : calc(50% - ((224px + 0px) / 2) + 0px);';
		...
		me._loading_text.ggUpdateText=function() {
			...
			var hs = player._("<b>Loading... %1%<\/b>", params);
			if (hs!=this.ggText) {
				this.ggText=hs;
		...
		hs+='bottom : 6px;';
		hs+='height : 32px;';
		hs+='left : calc(50% - ((277px + 0px) / 2) + 0.5px);';
		hs+='position : absolute;';
		hs+='visibility : inherit;';
		hs+='width : 277px;';
	...
	me.skinTimerEvent=function() {
		...
		me._loading_bar.style.transform=hs;
		...
		me._radar_beam.style.transform=hs;
	};
